...
#Uses a Bayes_Layer as function learner
...
class FINN_DiffSorp(FINN):
    ...
    def flux_kernel(self, t, u):
        ...
        ## (1/2) Calculate fluxes at the left boundary of control volumes i
        ...
        ## (2/2) Calculate fluxes at the right boundary of control volumes i
